...
function AdminUsersPage() {
  ...
  const { data, isLoading, error } = trpc.viewer.organizations.adminListUsers.useQuery({
    page,
    pageSize,
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <h1 className="text-emphasis mb-2 text-2xl font-bold">{t("admin_users_title")}</h1>
        <p className="text-default text-sm">{t("admin_users_description")}</p>
      </div>
...
AdminUsersPage.PageWrapper = PageWrapper;
